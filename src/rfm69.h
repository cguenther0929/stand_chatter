...
/* Over Current (OCP) Values */
#define RH_RF95_OCP_ON                          0x20
#define RH_RF95_OCP_TRIM                        0x1F
#define RH_RF95_OCP_LOW                         0x0F  // Lower 5 bits. Value <= 15 for ... Imax = 45 + 5*Val
#define RH_RF95_OCP_MED                         0x1B  // Lower 5 bits. 15 < Value <= 27 for ... Imax = -30+10*OcpTrim
#define RH_RF95_OCP_HI                          0x1F  // Lower 5 bits. 27 < Value <= 31 for ... Imax = 240mA
